...
const DotMatrix: React.FC<DotMatrixProps> = ({
  ...
  const uniforms = useMemo(() => {
    const colorArray = colors.length === 1
    ...
    return {
      u_colors: { value: colorArray.map(c => [c[0]/255, c[1]/255, c[2]/255]), type: "uniform3fv" },
...
const ShaderMaterial = ({
  ...
  const preparedUniforms = useMemo(() => {
    const obj: any = { ...uniforms };
    obj.u_time = { value: 0, type: "1f" };
